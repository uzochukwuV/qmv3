...
import { Copy, LogOut, Wallet, ExternalLink, Loader2, Coins } from 'lucide-react'
import { useNavigate } from 'react-router-dom'
import { useMagicSession } from '@/hooks/useMagicSession'
import { cn } from '@/lib/utils'
import FaucetModal from '@/components/tradebook/FaucetModal'

const navLinks = ['Live', 'Pre-Match', 'Outrights', 'LP', 'My Bets', 'Results']
  ...
  return (
    <>
        ...
        <div className="flex items-center gap-3 ml-auto shrink-0">
          {isLoggedIn && (
            <button
              ...
              className="hidden lg:inline-flex items-center gap-2 bg-cloud-whisper border border-light-pearl rounded-full px-3 py-1.5 text-[12px] text-dark-shale hover:text-midnight hover:border-midnight transition-colors"
            >
      ...
      <FaucetModal
        ...
        reloadMockTokenBalance={reloadMockTokenBalance}
      />
    </>
  )
}
